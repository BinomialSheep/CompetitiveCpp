  ...
  void stupid(vvi &G, vvi &ansX, vvi &ansY) {
    ...
    auto execDiagonal = [&](int startX, int startY) {
      ...
      if (r != -1 && t != -1) {
        ...
        if (G[x][y] == 0 && !isUsed(rx, ry, D56) && !isUsed(tx, ty, D74)) {
          bool isNG =
      ...
      if (t != -1 && l != -1) {
        ...
        if (G[x][y] == 0 && !isUsed(tx, ty, D67) && !isUsed(lx, ly, D45)) {
          bool isNG =
      ...
      if (l != -1 && b != -1) {
        ...
        if (G[x][y] == 0 && !isUsed(lx, ly, D74) && !isUsed(bx, by, D56)) {
          bool isNG =
      ...
      if (b != -1 && r != -1) {
        ...
        if (G[x][y] == 0 && !isUsed(bx, by, D45) && !isUsed(rx, ry, D67)) {
          bool isNG =
