...
struct Solver {
  ...
  void stupid(vvi &G, vvi &ansX, vvi &ansY) {
    ...
    auto exec = [&](int startX, int startY) {
      ...
      if (t != -1 && l != -1 && !G[l][t] &&
          (mx < abs(t - startY) + abs(l - startX) || randXor() % 2)) {
      ...
      if (l != -1 && b != -1 && !G[l][b] &&
          (mx < abs(l - startX) + abs(b - startY) || randXor() % 2)) {
      ...
      if (b != -1 && r != -1 && !G[r][b] &&
          (mx < abs(b - startY) + abs(r - startX) || randXor() % 2)) {
    ...
    auto execDiagonal = [&](int startX, int startY) {
      ...
      if (r != -1 && t != -1) {
        ...
        if (isEmpG(x, y) && !isUsed(rx, ry, D56) && !isUsed(tx, ty, D74)) {
          ...
          if (!isNG) {
            mx = r + t, d = 4, mxx = x, mxy = y;
          }
        }
      }
      // todo mxを入れる
      if (t != -1 && l != -1 && (mx < t + l || randXor() % 2)) {
        ...
        if (isEmpG(x, y) && !isUsed(tx, ty, D67) && !isUsed(lx, ly, D45)) {
          ...
          if (!isNG) {
            mx = t + l, d = 5, mxx = x, mxy = y;
          }
        }
      }
      if (l != -1 && b != -1 && (mx < l + b || randXor() % 2)) {
        ...
        if (isEmpG(x, y) && !isUsed(lx, ly, D74) && !isUsed(bx, by, D56)) {
          ...
          if (!isNG) {
            mx = l + b, d = 6, mxx = x, mxy = y;
          }
        }
      }
      if (b != -1 && r != -1 && (mx < b + r || randXor() % 2)) {
