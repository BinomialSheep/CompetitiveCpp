...
struct Solver {
  void solve() {
    ...
    static const double C = 1.15470053838;
    cout.precision(15);
    /* solve */
    auto f2 = [&](double x) { return x * pi / 180; };
    auto f = [&](double a, double x) -> double {
      //
      return a / sin(f2(90 - x));
    };
    auto f3 = [&](double b, double x) -> double {
      //
      return b / sin(f2(60 + x));
    };
