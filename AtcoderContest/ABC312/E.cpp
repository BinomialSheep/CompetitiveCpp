...
struct Solver {
  void solve() {
    /* input */
    INT(N);
    vvvi imos(101, vvi(101, vi(101)));
    vvi xyz(N, vi(6));
    rep(i, N) {
      INT(x1, y1, z1, x2, y2, z2);
      xyz[i][0] = x1, xyz[i][1] = y1, xyz[i][2] = z1, xyz[i][3] = x2,
      xyz[i][4] = y2, xyz[i][5] = z2;
    ...
    vi ans(N);
    rep(i, N) {
      int x1 = xyz[i][0], y1 = xyz[i][1], z1 = xyz[i][2], x2 = xyz[i][3],
          y2 = xyz[i][4], z2 = xyz[i][5];
